...
class RecipesByCategoryRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class RecipeByCategoryViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener { v: View ->
                ...
                CoroutineScope(Dispatchers.Main).launch{
                    ...
                    v.findNavController().navigate(RecipesByCategoryFragmentDirections.actionRecipesByCategoryToRecipe(recipe))
                }
            }
        }
        ...
        fun bind(recipe: Recipe) {
            ...
            recipeCategory.visibility = View.GONE
            recipeArea.visibility = View.GONE
        }
    }
}